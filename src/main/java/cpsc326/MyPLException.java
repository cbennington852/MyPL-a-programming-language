...
public class MyPLException extends RuntimeException {
  ...
  private enum ErrorType {
    LEXER_ERROR, PARSE_ERROR, STATIC_ERROR, VM_ERROR, DOCS_ERROR
  };
  ...
  public static void docsError(String message) {
    throw new MyPLException(message, ErrorType.DOCS_ERROR);
  }
